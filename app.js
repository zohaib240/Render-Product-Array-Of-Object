...
for (let i = 0; i < products.length; i++) {
    ...
    style="
    background-color: #f0f8ff; border-radius: 2px 50px 2px 50px;  width:25%; border: 1px solid white; padding: 10px; margin-left: 37%; margin-top: 1%;   height: 15rem; text-align: center; padding-top: 3%;">

<h1> Name : ${products[i].name} </h1>
  <h2> Age  : ${products[i].price }</h2>
